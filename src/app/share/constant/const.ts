...
export class Const {
    ...
    public static readonly AUTH_URL: string = 'http://192.168.8.108:18081/';
    public static readonly BACK_END_URL: string = 'http://192.168.8.104:2222/';
    public static readonly SOCKET_BACK_END_URL: string = 'http://192.168.8.104:9092/';
